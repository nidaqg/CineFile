...
if (moviesSeen != null) {
    for (i = 0; i < moviesSeen.length; i++) {

        let movieName = moviesSeen[i].title;
        let movieYear = (moviesSeen[i].release_date).substring(0, 4);
        let movieNameDiv = $("<h4>");
...
$(".seen").click(function () {
    ...
    $("#markSeen").text("Marked as seen");
    $("#markSeen").removeClass("w3-green").addClass("w3-black");
